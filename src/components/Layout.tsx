...
export default function Layout() {
  ...
  const adminNav: NavItem[] = [
    ...
    { to: '/todas-las-deudas', label: 'Todas las Deudas', icon: CreditCard },
  ...
  return (
    <div className="flex h-screen bg-gray-100 overflow-hidden">
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex flex-col w-60 bg-gray-800 flex-shrink-0">
        <SidebarContent />
      </aside>
      ...
      {open && (
        <div className="lg:hidden fixed inset-0 z-40 flex">
          ...
          <aside className="relative z-50 flex flex-col w-60 bg-gray-800">
